...
#define DS1EDIT_GOOD_DLL "Allegro 4.4.3, MSVC.s"
...
// Define missing OSTYPE constants for compatibility with older Allegro 4.2.3
#ifndef OSTYPE_WIN7
...
#endif
#ifndef OSTYPE_PSP
#define OSTYPE_PSP AL_ID('P', 'S', 'P', 0)
#endif
#include "anim.h"
#include "wEdit.h"
#include "undo.h"
...
int main(int argc, char *argv[])
{
   ...
   // Initialize global variables from allegro5_globals.c
   ds1editor_allegro5_init();
   ...
   {
   case OSTYPE_UNKNOWN:
      printf("unknown, or regular MSDOS\n");
      break;
   case OSTYPE_WIN3:
   ...
   case CPU_FAMILY_I386:
      printf("Intel-compatible 386\n");
      break;
   case CPU_FAMILY_I486:
      printf("Intel-compatible 486\n");
      break;
   case CPU_FAMILY_I586:
      printf("Pentium or equivalent\n");
      break;
   case CPU_FAMILY_I686:
      printf("Pentium Pro, II, III or equivalent\n");
      break;
   case CPU_FAMILY_ITANIUM:
      printf("Itanium processor\n");
      break;
   case CPU_FAMILY_POWERPC:
      printf("PowerPC processor\n");
      break;
   case CPU_FAMILY_EXTENDED:
      printf("needs to be read from the cpu_model\n");
      break;
   default:
      printf("?\n");
      break;
   ...
   else if (cpu_family == CPU_FAMILY_I686)
   {
      ...
      case CPU_MODEL_PENTIUMPRO:
         printf("CPU_MODEL_PENTIUMPRO\n");
         break;
      case CPU_MODEL_PENTIUMII:
         printf("CPU_MODEL_PENTIUMII\n");
         break;
      case CPU_MODEL_PENTIUMIIIKATMAI:
         printf("CPU_MODEL_PENTIUMIIIKATMAI\n");
         break;
      case CPU_MODEL_PENTIUMIIICOPPERMINE:
         printf("CPU_MODEL_PENTIUMIIICOPPERMINE\n");
         break;
      case CPU_MODEL_ATHLON:
         printf("CPU_MODEL_ATHLON\n");
         break;
      case CPU_MODEL_DURON:
         printf("CPU_MODEL_DURON\n");
         break;
      default:
         printf("?\n");
         break;
   ...
   else if (cpu_family == CPU_FAMILY_EXTENDED)
   {
      ...
      case CPU_MODEL_PENTIUMIV:
         printf("CPU_MODEL_PENTIUMIV\n");
         break;
      case CPU_MODEL_XEON:
         printf("CPU_MODEL_XEON\n");
         break;
      case CPU_MODEL_ATHLON64:
         printf("CPU_MODEL_ATHLON64\n");
         break;
      case CPU_MODEL_OPTERON:
         printf("CPU_MODEL_OPTERON\n");
         break;
      default:
         printf("?\n");
         break;
   ...
   else if (cpu_family == CPU_FAMILY_POWERPC)
   {
      ...
      case CPU_MODEL_POWERPC_601:
         printf("CPU_MODEL_POWERPC_601\n");
         break;
      case CPU_MODEL_POWERPC_602:
         printf("CPU_MODEL_POWERPC_602\n");
         break;
      case CPU_MODEL_POWERPC_603:
         printf("CPU_MODEL_POWERPC_603\n");
         break;
      case CPU_MODEL_POWERPC_604:
         printf("CPU_MODEL_POWERPC_604\n");
         break;
      case CPU_MODEL_POWERPC_620:
         printf("CPU_MODEL_POWERPC_620\n");
         break;
      case CPU_MODEL_POWERPC_750:
         printf("CPU_MODEL_POWERPC_750\n");
         break;
      case CPU_MODEL_POWERPC_7400:
         printf("CPU_MODEL_POWERPC_7400\n");
         break;
      case CPU_MODEL_POWERPC_7450:
         printf("CPU_MODEL_POWERPC_7450\n");
         break;
      default:
         printf("?\n");
         break;
